...
| 2026-07-26 | [Worker terminal mirror blank — bridge terminal-data mirror not flushing (separate track)](./2026-07-26-worker-mirror-blank-bridge-terminal-data.md) | open — bridge extension mirror not running; keep bridge-ported, do NOT daemon-PTY | medium |
