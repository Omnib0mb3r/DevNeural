...
| 2026-07-26 | [Worker terminal mirror blank — VS Code 1.130 removed the `terminalDataWriteEvent` proposed API](./2026-07-26-worker-mirror-blank-bridge-terminal-data.md) | open — CONFIRMED root cause; fix = migrate bridge capture to shell-integration API; keep bridge-ported, no daemon-PTY | medium |
